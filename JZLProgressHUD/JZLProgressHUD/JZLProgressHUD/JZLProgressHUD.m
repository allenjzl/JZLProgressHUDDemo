...
+(void)showMessage:(nullable NSString *)message {
    [self show:message onView:nil hudMode:JZLProgressHUDModeTextOnly afterDelay:DelayTime];
}
/// 只显示文字
/// @param message 要显示的文字
/// @param view   要显示的view
+(void)showMessage:(nullable NSString *)message onView:(nullable UIView *)view{
    [self show:message onView:view hudMode:JZLProgressHUDModeTextOnly afterDelay:DelayTime];
}
...
+(void)showMessage:(nullable NSString *)message afterDelayTime:(NSTimeInterval)delay{
    [self show:message onView:nil hudMode:JZLProgressHUDModeTextOnly afterDelay:delay];
}
/// 显示文字,自定义消失时间
/// @param message 要显示的文字
/// @param view 要显示的view
...
+(void)showSuccessWithMessage:(nullable NSString *)message {
    [self show:message onView:nil hudMode:JZLProgressHUDModeSuccess afterDelay:DelayTime];
}
/// 成功提示
/// @param message 要显示的文字
/// @param view 要显示的view
+(void)showSuccessWithMessage:(nullable NSString *)message onView:(nullable UIView *)view{
    [self show:message onView:view hudMode:JZLProgressHUDModeSuccess afterDelay:DelayTime];
}
...
+(void)showFailWithMessage:(nullable NSString *)message{
    [self show:message onView:nil hudMode:JZLProgressHUDModeFail afterDelay:DelayTime];
}
/// 失败提示
/// @param message 要显示的文字
/// @param view 要显示的view
+(void)showFailWithMessage:(nullable NSString *)message onView:(nullable UIView *)view{
    [self show:message onView:view hudMode:JZLProgressHUDModeFail afterDelay:DelayTime];
}
...
+(void)showMessage:(nullable NSString *)message imageName:(NSString *)imageName{
    ...
    [self show:message onView:nil hudMode:JZLProgressHUDModeCustomerImage customImgView:imgView afterDelay:DelayTime];
}
/// 自定义图片显示
/// @param message 要显示的文字
/// @param imageName 要显示的图片
...
+(void)showMessage:(nullable NSString *)message imageName:(NSString *)imageName onView:(nullable UIView *)view{
    UIImageView *imgView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:imageName]];
    [self show:message onView:view hudMode:JZLProgressHUDModeCustomerImage customImgView:imgView afterDelay:DelayTime];
}
...
+(void)showCustomAnimationWithMessage:(nullable NSString *)message withImageArry:(NSArray *)imgArry{
    ...
    [self show:message onView:nil hudMode:JZLProgressHUDModeCustomAnimation customImgView:imgView afterDelay:0];
}
/// 显示动画
/// @param message 要显示的文字
/// @param imgArry 帧动画数组
...
+(void)showCustomAnimationWithMessage:(nullable NSString *)message withImageArry:(NSArray *)imgArry onView:(nullable UIView *)view{
    ...
    [imgView setAnimationDuration:imgArry.count  * 0.25];
    [imgView startAnimating];
    [self show:message onView:view hudMode:JZLProgressHUDModeCustomAnimation customImgView:imgView afterDelay:0];
}
...
+(void)showLoadingWithMessage:(nullable NSString *)message{
    [self show:message onView:nil hudMode:JZLProgressHUDModeLoading afterDelay:0];
}
/// 显示正在加载菊花
/// @param message 要显示的文字
/// @param view 要显示的view
+(void)showLoadingWithMessage:(nullable NSString *)message onView:(nullable UIView *)view{
    [self show:message onView:view hudMode:JZLProgressHUDModeLoading afterDelay:0];
}
...
+(void)showCircleLoadingWithMessage:(nullable NSString *)message{
    [self show:message onView:nil hudMode:JZLProgressHUDModeCircle afterDelay:0];
}
/// 显示正在加载圆圈
/// @param message 要显示的文字
/// @param view 要显示的view
+(void)showCircleLoadingWithMessage:(nullable NSString *)message onView:(nullable UIView *)view{
    [self show:message onView:view hudMode:JZLProgressHUDModeCircle afterDelay:0] ;
...
+ (void)show:(nullable NSString *)message onView:(nullable UIView *)view hudMode:(JZLProgressHUDMode)hudMode afterDelay:(double)afterDelay  {
    [self show:message onView:view hudMode:hudMode customImgView:nil afterDelay:afterDelay ];
    
}

+ (void)show:(nullable NSString *)message onView:(nullable UIView *)view hudMode:(JZLProgressHUDMode)hudMode customImgView:(UIImageView *)customImgView afterDelay:(double)afterDelay{
    dispatch_async(dispatch_get_main_queue(), ^{
         UIView *showView = view;
        if (showView == nil)  showView = (UIView*)[UIApplication sharedApplication].delegate.window;
        // 如果当前存在,则先消失
        ...
        [JZLProgressHUD shareInstance].hud = [MBProgressHUD showHUDAddedTo:showView animated:YES];
        // 设置背景颜色
        if ([JZLProgressHUD shareInstance].HUDStyle == JZLProgressHUDStyleBlack) {
            [JZLProgressHUD shareInstance].hud.bezelView.color = [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:0.8];
            [JZLProgressHUD shareInstance].hud.contentColor = [UIColor whiteColor];
        ...
        if (afterDelay > 0) {
            [[JZLProgressHUD shareInstance].hud hideAnimated:YES afterDelay:afterDelay];
             [JZLProgressHUD shareInstance].hud = nil;
        }
    });
